...
export default function NavBar() {
    ...
    return (
        <>
            <header className="p-2 grid grid-cols-3 gap-12 items-center bg-blue-100">
                <div className="flex col-span-1 col-start-2 justify-center">
                    <div className="cursor-pointer bg-blue-300 p-2 rounded-full justify-self-center">
                        <div className="h-8 aspect-square" onClick={() => window.history.pushState({}, "", "/")}>
                ...
                <div className="flex justify-end">
                    <div className="bg-blue-300 p-2 rounded-full text-blue-900">
                        ...
                        <div className={(showProfileMenu? "profile-open":"profile-close") + " profile-bar"}>
                            <div  onClick={() => window.history.pushState({}, "", "/parameter")}>
                                <div>
